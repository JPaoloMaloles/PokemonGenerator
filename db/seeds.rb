        ...
        if !(info.inspect == "\" \"")
          ...
          if is_over == false
            inforaw.each do |item|
              ...
              # end
              # 
              is_move_indicators = [ "Standard Level Up", "Alola Form Level Up", "Galarian Form Level Up", "Paldean Form Level Up","Technical Machine Attacks", "Level Up - Midnight Form", "Level Up - Dusk Form"]
